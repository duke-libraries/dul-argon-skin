...
describe SolrDocument do
  ...
  describe 'duke_requestable?' do
    context 'item in Duke collection and at the library' do
      let(:solr_document) do
        SolrDocument.new(
          id: 'DUKE012345678',
    ...
    context 'item at the library, but not in Duke collection' do
      let(:solr_document) do
        SolrDocument.new(
          id: 'UNC012345678',
    ...
    context 'item in Duke collection, but online-only' do
      let(:solr_document) do
        SolrDocument.new(
          id: 'DUKE012345678',
